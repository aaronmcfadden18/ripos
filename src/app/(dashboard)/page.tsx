    ...
    <div className="dash">
      ...
      <div className="dash-header">
        ...
        <div style={{display:'flex',gap:'10px'}}>
          ...
          <Link href="/streams/new" className="dash-cta" id="tour-new-stream">+ New stream</Link><button className="dash-signout" onClick={async()=>{const {createClient}=await import("@/lib/supabase/client");const sb=createClient();window.location.href="/home";await sb.auth.signOut()}}>Sign out</button>
        </div>
      </div>
