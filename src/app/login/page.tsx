...
export default function LoginPage() {
  ...
  if (!showAuth) return (
    <div className="land">
      ...
      <section className="land-section" style={{display:'flex',flexDirection:'column',alignItems:'center',padding:'60px 24px'}}>
        <p style={{fontSize:'11px',color:'#52525b',textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:'24px'}}>What you get</p>
        <img src="/screenshot-stream.png" alt="RipOS new stream" style={{width:'100%',maxWidth:'860px',borderRadius:'12px',border:'1px solid rgba(255,255,255,0.08)'}}/>
      </section>
